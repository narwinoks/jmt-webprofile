        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="title" name="title"
                    placeholder="Fullstact Progammer">
        ...
        <div class="col-12">
            <div class="mb-3">
                ...
                <textarea class="form-control" name="description" id="description" rows="6"
                    placeholder="Melakukan Pemeliharaan.."></textarea>
            </div>
        </div>
        <div class="col-12">
            <div class="mb-3">
                <label class="form-label">Contact</label>
                <textarea class="form-control" name="contact" id="contact" rows="6" placeholder="Kirim lamaran anda.."></textarea>

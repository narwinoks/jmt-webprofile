...
@push('scripts')
    <!-- Libs JS -->
    <script src="{{ asset('assets/template/libs/apexcharts/dist/apexcharts.min.js?1684106062') }}" defer></script>
    <script src="{{ asset('assets/template/libs/jsvectormap/dist/js/jsvectormap.min.js?1684106062') }}" defer></script>
    <script src="{{ asset('assets/template/libs/jsvectormap/dist/maps/world.js?1684106062') }}" defer></script>
    <script src="{{ asset('assets/template/libs/jsvectormap/dist/maps/world-merc.js?1684106062') }}" defer></script>
    <script>
        // @formatter:off

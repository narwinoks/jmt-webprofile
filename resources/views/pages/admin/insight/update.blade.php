            ...
            <div class="row row-cards">
                <div class="col-12">
                    <form method="POST" id="formAddInsight" enctype="multipart/form-data" class="card">
                        @csrf
                        <input type="hidden" class="form-control" name="id" value="{{ $insight->id }}" id="id">
                        <input type="hidden" class="form-control" name="oldTitle" value="{{ $insight->title }}">
                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                        ...
                                        <div class="col-md-12 col-xl-12">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="title"
                                                    placeholder="Masukan Judul Artikel" value="{{ $insight->title }}">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-xl-12">
                                            <div class="mb-3">
                                                ...
                                                <textarea class="tinymce" name="content" rows="6" placeholder="Content..">{{ $insight->content }}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="card mt-5">
                                            <div class="card-body">
                                                <div class="row" id="image-priview">
                                ...
                                <div class="col-md-12 col-xl-12" style="display: none" id="meta_data">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="meta" rows="5">{{ $insight->meta->description ?? null }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            $('#bt-save-insight').on('click', function(e) {
                ...
                $.ajax({
                    url: '{{ route('admin.content.update') }}',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,

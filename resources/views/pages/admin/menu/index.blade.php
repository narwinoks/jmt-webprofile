...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-lg-12">
                    <button class="btn btn-primary" id="add-menu">
                        Tambah
                    </button>
                </div>
                <div class="col-lg-12">
                    <div class="card">
                        <div class="p-4">
                            <table class="table table-vcenter table-nowrap" id="table-menu">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Name</th>
    ...
    <div class="modal fade modal-blur" id="modal-menu" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"

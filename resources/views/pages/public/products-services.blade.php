            ...
            <div class="row valign">
                <div class="col-md-6 align-self-center" data-valign-overlay="middle">
                    <img class="img-fluid center-block bottom-m asset-box-shadow-img" alt=""
                        src="assets/images/ps-hardware.webp">
                </div>
                <div class="col-md-6 text-left">
                    <h4 class="mb-4"><strong>Network Solutions</strong></h4>
    ...
    <section class="page-section-ptb">
        <div class="container">
            <div class="row valign">
                <div class="col-md-6 align-self-center" data-valign-overlay="middle">
                    <img class="img-fluid center-block bottom-m asset-box-shadow-img" alt=""
                        src="assets/images/ps-software-01.webp">
                </div>
                <div class="col-md-6">
                    <h4 class="mb-4"><strong>Software Solutions</strong></h4>

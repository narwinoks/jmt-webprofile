                    ...
                    <div class="blog-entry mb-3">
                        <div class="owl-carousel" data-nav-dots="true" data-nav-arrow="false" data-items="1" data-sm-items="1"
                            ...
                            <div class="item">
                                <div class="video-local-container">
                                    <video width="50%" height="auto" autoplay muted controls
                                        ...
                                        <source
                                            src="assets/video/alasan kenapa faskes harus beralih ke rekam medis elektronik.mp4">
                            ...
                            <div class="item">
                                <div class="video-local-container">
                                    <video width="50%" height="auto" autoplay muted controls
                                        class="video-local-thumbnail">
                                        <source src="assets/video/peran jmt utk rumah sakit.mp4">
                                        <p class="warning">Your browser does not support HTML5 video.</p>
                                    </video>
                                </div>
                            </div>
                            <div class="item">
                                <div class="video-local-container">
                                    <video width="50%" height="auto" autoplay muted controls
                                        class="video-local-thumbnail">
                                        <source src="assets/video/seberapa penting teknologi kesehatan.mp4">
                                        <p class="warning">Your browser does not support HTML5 video.</p>
                                    </video>
                                </div>
                            </div>
                        ...
                        <div class="blog-detail mt-3">
                            <div class="entry-title mb-1"><br>
                                <h5><strong>Alasan kenapa Faskes harus beralih ke Rekam Medis Elektronik</strong></h5>
                            </div>
